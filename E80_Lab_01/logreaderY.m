...
%do statistics for uncertainty line in Y
bar = mean(accelY); %mean of all Y values
S = std(accelY);    %standard deviation of Y values
N = length(accelY)  %length of accelY 
df = N-1
ESE = S/sqrt(N)
t = 1.999
lambda = t * ESE
